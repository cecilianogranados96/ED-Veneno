/*! jQuery Mobile 1.4.0-alpha.2 | Git HEAD hash: 1e27844 <> 2013-08-15T13:53:49Z | (c) 2010, 2013 jQuery Foundation, Inc. | jquery.org/license */ ! function(a, b, c) {
    ...
    function(a, b) {
        a.extend(a.mobile, {
            ...
            enhanceWithin: function() {
                var b, c = this;
                return a.mobile.nojs && a.mobile.nojs(this), a.mobile.links && a.mobile.links(this), a.mobile.degradeInputsWithin && a.mobile.degradeInputsWithin(this), a.fn.buttonMarkup && a(a.fn.buttonMarkup.initSelector).buttonMarkup(), a.fn.fieldcontain && this.find(":jqmData(role='fieldcontain')").jqmEnhanceable().fieldcontain(), a.each(a.mobile.widgets, function(d, e) {
                    e.initSelector && (b = a.mobile.enhanceable(c.find(e.initSelector)), b.length && (b = b.not(a.mobile.page.prototype.keepNativeSelector())), b[e.prototype.widgetName]())
                }), this
            },
    ...
    function(a) {
        ...
        a.extend(a.Widget.prototype, {
            ...
            enhanceWithin: function(b, c) {
                this.enhance(a(a[this.namespace][this.widgetName].initSelector, a(b)), c)
            },
    ...
    function(a, d) {
        ...
        function i() {
            ...
            return e.length ? g = e.attr("href") : e = f = a("<base>", {
                href: d
            }).appendTo("head"), b = a("<a href='testurl' />").prependTo(n), c = b[0].href, e[0].href = g || location.pathname, f && f.remove(), 0 === c.indexOf(d)
        }
        ...
        N && c.addEventListener("click", function(b) {
            ...
            if (i)
                for (c = b.clientX, d = b.clientY, x = a.vmouse.clickDistanceThreshold, e = j; e;) {
                    for (f = 0; i > f; f++)
                        if (g = K[f], h = 0, e === j && Math.abs(g.x - c) < x && Math.abs(g.y - d) < x || a.data(e, A) === g.touchID) return b.preventDefault(), b.stopPropagation(), void 0;
                    e = e.parentNode
                }
        }, !0)
    }(a, b, c),
        ...
        a.each("touchstart touchmove touchend tap taphold swipe swipeleft swiperight scrollstart scrollstop".split(" "), function(b, c) {
            ...
            setup: function() {
                ...
                e.bind("vmousedown", function(g) {
                    ...
                    if (f = !1, g.which && 1 !== g.which) return !1;
                    var k, l = g.target;
                    e.bind("vmouseup", h).bind("vclick", j), d.bind("vmousecancel", i), k = setTimeout(function() {
            ...
            setup: function() {
                ...
                c.bind(g, function(d) {
                    ...
                    var f, g = a.event.special.swipe.start(d),
                        j = d.target,
                        k = !1;
    ...
    function(a, b) {
        ...
        a.support.orientation && (i = b.innerWidth || l.width(), j = b.innerHeight || l.height(), k = 50, g = i > j && i - j > k, h = n[b.orientation], (g && h || !g && !h) && (n = {
            ...
            setup: function() {
                return a.support.orientation && !a.event.special.orientationchange.disabled ? !1 : (f = e(), l.bind("throttledresize", d), void 0)
            },
            teardown: function() {
                return a.support.orientation && !a.event.special.orientationchange.disabled ? !1 : (l.unbind("throttledresize", d), void 0)
            },
            add: function(a) {
                var b = a.handler;
    ...
    function(a, b) {
        ...
        a.widget = function(c) {
            ...
            _create: function() {
                ...
                }), this.element.enhanceWithin(), "dialog" === a.mobile.getAttribute(this.element[0], "role") && a.mobile.dialog && this.element.dialog(), void 0)
            },
            _enhance: function() {
            ...
            bindRemove: function(b) {
                var c = this.element;
                !c.data("mobile-page").options.domCache && c.is(":jqmData(external-page='true')") && c.bind("pagehide.remove", b || function() {
                    var b = a(this),
            ...
            removeContainerBackground: function() {
                this.element.closest(":mobile-content").content({
                    theme: "none"
                })
            },
    ...
    function(a, d) {
        function e(b) {
            !n || n.closest("." + a.mobile.activePageClass).length && !b || n.removeClass(a.mobile.activeBtnClass), n = null
        }

        function f() {
            r = !1, q.length > 0 && a.mobile.changePage.apply(null, q.pop())
        }

        function g() {
            var b = a.mobile.activePage && i(a.mobile.activePage);
            return b || v.hrefNoHash
        }
        ...
        function i(b) {
            var c = a(b).closest(".ui-page").jqmData("url"),
                d = v.hrefNoHash;
            return a.mobile.dynamicBaseEnabled && c && l.isPath(c) || (c = d), l.makeUrlAbsolute(c, d)
        }
        a.widget("mobile.content", {
            options: {
                theme: "a"
            },
            initSelector: !1,
            _create: function() {
                var c = a(b);
                this.setLastScrollEnabled = !0, this._on(c, {
                ...
                }), c.one("navigate", a.proxy(function() {
            ...
            _afterContentChange: function() {
                this.setLastScrollEnabled = !0, this._off(j, "scrollstop"), this._on(j, {
                    scrollstop: "_delayedRecordScroll"
                })
            },
            ...
            _getActiveHistory: function() {
                return a.mobile.urlHistory.getActive()
            },
            ...
            _handleDestination: function(b) {
                var c, d;
                return "string" === a.type(b) && (b = l.stripHash(b)), b && (c = this._getHistory(), d = this._getDocumentBase(), b = l.isPath(b) ? b : l.makeUrlAbsolute("#" + b, d), b === l.makeUrlAbsolute("#" + c.initialDst, d) && c.stack.length && c.stack[0].url !== c.initialDst.replace(s, "") && (b = this._getInitialContent())), b || this._getInitialContent()
            },
            _handleDialog: function(b, c) {
                var d, e, f = this._getActiveContent();
                return f && !f.hasClass("ui-dialog") ? ("back" === c.direction ? this._back() : this._forward(), !1) : (d = c.pageUrl, e = this._getActiveHistory(), a.extend(b, {
                    role: e.role,
            ...
            _handleNavigate: function(b, c) {
                ...
                }), f.activeIndex > 0 && e.indexOf(s) > -1 && f.initialDst !== e && (e = this._handleDialog(h, c), e === !1) || this._changeContent(this._handleDestination(e), h)
            },
            ...
            _getLoader: function() {
                return a.mobile.loaderWidget
            },
            _showLoading: function(b, c, d, e) {
                this._loadMsg = setTimeout(a.proxy(function() {
                    this._getLoader().loader("show", c, d, e)
                }, this), b)
            },
            _hideLoading: function() {
                clearTimeout(this._loadMsg), this._getLoader().loader("hide")
            },
            _showError: function() {
            ...
            _parse: function(b, c) {
                var d, e = a("<div></div>");
                return e.get(0).innerHTML = b, d = e.find(":jqmData(role='page'), :jqmData(role='dialog')").first(), d.length || (d = a("<div data-" + this._getNs() + "role='page'>" + (b.split(/<\/?body[^>]*>/gim)[1] || "") + "</div>")), d.attr("data-" + this._getNs() + "url", l.convertUrlToDataUrl(c)).attr("data-" + this._getNs() + "external-page", !0), d
            },
            ...
            _createDataUrl: function(a) {
                return l.convertUrlToDataUrl(a)
            },
            _createFileUrl: function(a) {
                return l.getFilePath(a)
            },
            ...
            _loadSuccess: function(b, c, e, f) {
                ...
                return a.proxy(function(i, j, k) {
                    var m, n = new RegExp("(<[^>]+\\bdata-" + this._getNs() + "role=[\"']?page[\"']?[^>]*>)"),
                        o = new RegExp("\\bdata-" + this._getNs() + "url=[\"']?([^\"'>]*)[\"']?");
            ...
            load: function(b, c) {
                var e, f, g, h, i = c.deferred || a.Deferred(),
                    j = a.extend({}, this._loadDefaults, c),
                    k = null,
                    m = l.makeUrlAbsolute(b, this._getBaseWithDefault());
                return j.reload = j.reloadPage, j.data && "get" === j.type && (m = l.addSearchParams(m, j.data), j.data = d), j.data && "post" === j.type && (j.reload = !0), e = this._createFileUrl(m), f = this._createDataUrl(m), k = this._find(m), 0 === k.length && l.isEmbeddedPage(e) && !l.isFirstPageUrl(e) ? (i.reject(m, j), void 0) : (this._getBase().reset(), k.length && !j.reload ? (this._enhance(k, j.role), i.resolve(m, j, k), j.prefetch || this._getBase().set(b), void 0) : (h = {
                    url: b,
                    absUrl: m,
                    dataUrl: f,
                    deferred: i,
                    options: j
                }, g = this._triggerWithDeprecated("beforeload", h), g.deprecatedEvent.isDefaultPrevented() || g.event.isDefaultPrevented() ? void 0 : (j.showLoadMsg && this._showLoading(j.loadMsgDelay), j.prefetch === d && this._getBase().reset(), a.mobile.allowCrossDomainPages || l.isSameDomain(u, m) ? (a.ajax({
                    url: e,
                    type: j.type,
                    data: j.data,
                    contentType: j.contentType,
                    dataType: "html",
                    success: this._loadSuccess(m, h, j, i),
                    error: this._loadError(m, h, j, i)
                }), void 0) : (i.reject(m, j), void 0))))
            },
            _loadError: function(b, c, d, e) {
                return a.proxy(function(a, f, g) {
                    this._getBase().set(l.get()), c.xhr = a, c.textStatus = f, c.errorThrown = g;
                    var h = this._triggerWithDeprecated("loadfailed", c);
                    h.deprecatedEvent.isDefaultPrevented() || h.event.isDefaultPrevented() || (d.showLoadMsg && this._showError(), e.reject(b, d))
                }, this)
            },
            ...
            _triggerCssTransitionEvents: function(b, c, d) {
                d = d || "", c && this._triggerWithDeprecated(d + "hide", {
                    nextPage: b
            ...
            _loadUrl: function(b, c, d) {
                d.target = b, d.deferred = a.Deferred(), this.load(b, d), d.deferred.done(a.proxy(function(a, b, d) {
                    r = !1, b.absUrl = c.absUrl, this.transition(d, c, b)
            ...
            _triggerPageBeforeChange: function(b, c, d) {
                ...
                return a.extend(c, {
                    toPage: b,
                    options: d
                }), c.absUrl = "string" === a.type(b) ? l.makeUrlAbsolute(b, g()) : d.absUrl, this.element.trigger(e, c), e.isDefaultPrevented() ? !1 : !0
            },
            change: function(b, c) {
                if (r) return q.unshift(arguments), void 0;
                var d = a.extend({}, a.mobile.changePage.defaults, c),
                    e = {};
                d.fromPage = d.fromPage || a.mobile.activePage, this._triggerPageBeforeChange(b, e, d) && (b = e.toPage, "string" === a.type(b) ? (r = !0, this._loadUrl(b, e, d)) : this.transition(b, e, d))
            },
            transition: function(b, g, h) {
                var i, j, k, m, n, o, t, v, w, x, y, z, A, B;
                if (r) return q.unshift([b, h]), void 0;
                if (this._triggerPageBeforeChange(b, g, h) && (B = this._triggerWithDeprecated("beforetransition", g), !B.deprecatedEvent.isDefaultPrevented() && !B.event.isDefaultPrevented())) {
                    if (r = !0, b[0] !== a.mobile.firstPage[0] || h.dataUrl || (h.dataUrl = u.hrefNoHash), i = h.fromPage, j = h.dataUrl && l.convertUrlToDataUrl(h.dataUrl) || b.jqmData("url"), k = j, m = l.getFilePath(j), n = p.getActive(), o = 0 === p.activeIndex, t = 0, v = c.title, w = ("dialog" === h.role || "dialog" === b.jqmData("role")) && b.jqmData("dialog") !== !0, i && i[0] === b[0] && !h.allowSamePageTransition) return r = !1, this._triggerWithDeprecated("transition", g), this.element.trigger("pagechange", g), h.fromHashChange && p.direct({
                        url: j
                    }), void 0;
                    b.page({
                        role: h.role
                    }), h.fromHashChange && (t = "back" === h.direction ? -1 : 1);
                    try {
                    ...
                    x = !1, w && n && (n.url && n.url.indexOf(s) > -1 && a.mobile.activePage && !a.mobile.activePage.hasClass("ui-dialog") && p.activeIndex > 0 && (h.changeHash = !1, x = !0), j = n.url || "", j += !x && j.indexOf("#") > -1 ? s : "#" + s, 0 === p.activeIndex && j === p.initialDst && (j += s)), y = n ? b.jqmData("title") || b.children(":jqmData(role='header')").find(".ui-title").text() : v, y && v === c.title && (v = y), b.jqmData("title") || b.jqmData("title", v), h.transition = h.transition || (t && !o ? n.transition : d) || (w ? a.mobile.defaultDialogTransition : a.mobile.defaultPageTransition), !t && x && (p.getActive().pageUrl = k), j && !h.fromHashChange && (!l.isPath(j) && j.indexOf("#") < 0 && (j = "#" + j), z = {
                        transition: h.transition,
                        title: v,
                        pageUrl: k,
                        role: h.role
                    }, h.changeHash !== !1 && a.mobile.hashListeningEnabled ? a.mobile.navigate(j, z, !0) : b[0] !== a.mobile.firstPage[0] && a.mobile.navigate.history.add(j, z)), c.title = v, a.mobile.activePage = b, h.reverse = h.reverse || 0 > t, A = a.Deferred(), this._cssTransition(b, i, {
                        transition: h.transition,
                        reverse: h.reverse,
                        deferred: A
                    }), A.done(a.proxy(function(c, d, i, j, k) {
                        e(), h.duplicateCachedPage && h.duplicateCachedPage.remove(), k || a.mobile.focusPage(b), f(), this.element.trigger("pagechange", g), this._triggerWithDeprecated("transition", g)
                    }, this))
                }
            }
        }), a.mobile.loadPage = function(b, c) {
            var d;
            return c = c || {}, d = c.pageContainer || a.mobile.pageContainer, c.deferred = a.Deferred(), d.content("load", b, c), c.deferred.promise()
        };
        var j = a.mobile.window,
            k = a("head"),
            l = a.extend(a.mobile.path, {
                getFilePath: function(b) {
                    var c = "&" + a.mobile.subPageUrlKey;
                    return b && b.split(c)[0].split(s)[0]
                },
                isFirstPageUrl: function(b) {
                    var c = l.parseUrl(l.makeUrlAbsolute(b, this.documentBase)),
            ...
            v = l.documentBase,
            w = {
                element: t.length ? t : a("<base>", {
                    href: v.hrefNoHash
                }).prependTo(k),
                linkSelector: "[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]",
                set: function(b) {
                    a.mobile.dynamicBaseEnabled && a.support.dynamicBaseTag && w.element.attr("href", l.makeUrlAbsolute(b, v))
                },
                rewrite: function(b, c) {
                    var d = l.get(b);
                    c.find(w.linkSelector).each(function(b, c) {
                        var e = a(c).is("[href]") ? "href" : a(c).is("[src]") ? "src" : "action",
                            f = a(c).attr(e);
                        f = f.replace(location.protocol + "//" + location.host + location.pathname, ""), /^(\w+:|#|\/)/.test(f) || a(c).attr(e, d + f)
                    })
                },
                reset: function() {
                    w.element.attr("href", v.hrefNoSearch)
                }
            };
        a.mobile.getDocumentUrl = l.getDocumentUrl, a.mobile.getDocumentBase = l.getDocumentBase, a.mobile.back = function() {
            var a = b.navigator;
        ...
        }, a.mobile.path = l, a.mobile.base = w, a.mobile.urlHistory = p, a.mobile.dialogHashKey = s, a.mobile.allowCrossDomainPages = !1, a.mobile.changePage = function(b, c) {
            a.mobile.pageContainer.content("change", b, c)
            ...
            a.mobile.document.delegate("form", "submit", function(b) {
                ...
                if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                    if (m = a(g), a.data(g, "mobile-button")) {
                        if (!c(a(g).closest("form"), !0)) return;
                        g.parentNode && (g = g.parentNode)
                    } else {
                        if (g = h(g), !g || "#" === l.parseUrl(g.getAttribute("href") || "#").hash) return;
                        if (!a(g).jqmHijackable().length) return
                    }~g.className.indexOf("ui-link-inherit") ? g.parentNode && (f = a.data(g.parentNode, "buttonElements")) : f = a.data(g, "buttonElements"), f ? g = f.outer : i = !0, d = a(g), i && (d = d.closest(".ui-btn")), d.length > 0 && !d.hasClass("ui-disabled") && (e(!0), n = d, n.addClass(a.mobile.activeBtnClass))
                }
            }), a.mobile.document.bind("click", function(c) {
                if (a.mobile.linkBindingEnabled && !c.isDefaultPrevented()) {
                    var f, g, j, k, m, n, o, p, q = h(c.target),
                        r = a(q);
                    if (q && !(c.which > 1) && r.jqmHijackable().length) {
                        if (f = function() {
                                b.setTimeout(function() {
                                    e(!0)
                                }, 200)
                            }, r.is(":jqmData(rel='back')")) return a.mobile.back(), !1;
                        if (g = i(r), j = l.makeUrlAbsolute(r.attr("href") || "#", g), !a.mobile.ajaxEnabled && !l.isEmbeddedPage(j)) return f(), void 0;
                        if (-1 !== j.search("#")) {
                            if (j = j.replace(/[^#]*#/, ""), !j) return c.preventDefault(), void 0;
                            j = l.isPath(j) ? l.makeUrlAbsolute(j, g) : l.makeUrlAbsolute("#" + j, u.hrefNoHash)
                        }
                        if (k = r.is("[rel='external']") || r.is(":jqmData(ajax='false')") || r.is("[target]"), m = k || l.isExternal(j) && !l.isPermittedCrossDomainRequest(u, j)) return f(), void 0;
                        n = r.jqmData("transition"), o = "reverse" === r.jqmData("direction") || r.jqmData("back"), p = r.attr("data-" + a.mobile.ns + "rel") || d, a.mobile.changePage(j, {
                            transition: n,
                            reverse: o,
                            role: p,
                            link: r
            ...
            }), a.mobile.pageContainer.content(), a.mobile.document.bind("pageshow", a.mobile.resetActivePageHeight), a.mobile.window.bind("throttledresize", a.mobile.resetActivePageHeight)
        }, a(function() {
            o.resolve()
        }), a.when(o, a.mobile.navreadyDeferred).done(function() {
    ...
    function(a, b) {
        a.mobile.Transition = function() {
            ...
            doneIn: function() {
                this.beforeDoneIn(), this.$to.removeClass("out in reverse " + this.name).height(""), this.toggleViewportClass(), a.mobile.window.scrollTop() !== this.toScroll && this.scrollPage(), this.deferred.resolve(this.name, this.reverse, this.$to, this.$from, !0)
            },
            ...
            transition: function() {
                var b = this.reverse ? " reverse" : "",
                    ...
                    e = !a.support.cssTransitions || d || !this.name || "none" === this.name || Math.max(a.mobile.window.scrollTop(), this.toScroll) > a.mobile.getMaxScrollForTransition();
                return this.toScroll = a.mobile.urlHistory.getActive().lastScroll || a.mobile.defaultHomeScroll, this.toggleViewportClass(), this.$from && !e ? this.startOut(c, b, e) : this.doneOut(c, b, e, !0), this.deferred.promise()
            }
        })
    }(a, this),
    function(a) {
    ...
    function(a, b, c) {
        a.widget("mobile.page", a.mobile.page, {
            ...
            _handlePageBeforeShow: function() {
                this.options.overlayTheme ? (this.removeContainerBackground(), this.setContainerBackground(this.options.overlayTheme)) : this._super()
            },
            ...
            close: function() {
                ...
                a.mobile.hashListeningEnabled && d.activeIndex > 0 ? a.mobile.back() : (b = Math.max(0, d.activeIndex - 1), c = d.stack[b].pageUrl || d.stack[b].url, d.previousIndex = d.activeIndex, d.activeIndex = b, a.mobile.path.isPath(c) || (c = a.mobile.path.makeUrlAbsolute("#" + c)), a.mobile.changePage(c, {
                    direction: "back",
                    changeHash: !1,
                    fromHashChange: !0
                }))
    ...
    function(a, b, c) {
        a.widget("mobile.dialog", {
            ...
            _handleVClickSubmit: function(b) {
                ...
                d.length && !d.jqmData("transition") && (c = {}, c["data-" + a.mobile.ns + "transition"] = (a.mobile.urlHistory.getActive() || {}).transition || a.mobile.defaultDialogTransition, c["data-" + a.mobile.ns + "direction"] = "reverse", d.attr(c))
            },
            _create: function() {
                var b = this.element,
                    c = this.options;
    ...
    function(a, b) {
        ...
        a.widget("mobile.collapsible", {
            ...
            _enhance: function(b, c) {
                var d, e = this._getOptions(this.options),
            ...
            refresh: function() {
                var b, c = {};
                for (b in a.mobile.collapsible.defaults) c[b] = this.options[b];
                this._setOptions(c)
            },
            _setOptions: function(a) {
        ...
        a.widget("mobile.collapsibleset", a.extend({
            ...
            _setOptions: function(a) {
                var c, d = this.element,
                    e = this._themeClassFromOption("ui-group-theme-", a.theme);
                return e && d.removeClass(this._themeClassFromOption("ui-group-theme-", this.options.theme)).addClass(e), a.corners !== b && d.toggleClass("ui-corner-all", a.corners), c = this._super(a), this.element.children(":mobile-collapsible").collapsible("refresh"), c
            },
            _destroy: function() {
                var a = this.element;
            ...
            _refresh: function(b) {
                ...
                a.mobile.collapsible.prototype.enhance(d.not(".ui-collapsible")), this._addFirstLastClasses(d, this._getVisibles(d, b), b)
            },
            refresh: function() {
                this._refresh(!1)
            }
        ...
        a.widget("mobile.navbar", {
            ...
            _create: function() {
                ...
                d.addClass("ui-navbar").attr("role", "navigation").find("ul").jqmEnhanceable().grid({
                    ...
                    var b;
                    a(this).is(".ui-disabled, .ui-btn-active") || (e.removeClass(a.mobile.activeBtnClass), a(this).addClass(a.mobile.activeBtnClass), b = a(this), a(c).one("pagehide", function() {
    ...
    function(a, b) {
        ...
        a.mobile.filterable.prototype.options.filterCallback = function(a, b) {
            ...
            _setWidget: function(a) {
                return !this._widget && a && (this._widget = a, this._widget._setOptions = c(this, this._widget._setOptions)), this._widget && this._syncTextInputOptions(this._widget.options), !!this._widget
            },
            ...
            _setInput: function(b) {
                ...
                this._super(b), this._search && d && this._search.attr("placeholder", this.options.filterPlaceholder)
            },
            _setOptions: function(c) {
                var d = this._super(c);
                return c.filterPlaceholder !== b && this._search && this._search.attr("placeholder", c.filterPlaceholder), c.filterTheme !== b && this._search && a.mobile.textinput && this._search.textinput("option", "theme", c.filterTheme), d
            },
            _destroy: function() {
    ...
    function(a) {
        ...
        a.widget("mobile.listview", a.mobile.listview, {
            ...
            _afterListviewRefresh: function() {
                var a = this.element;
                this._off(a, "listviewafterrefresh"), this._replaceDividers(), this.refresh(), this._on(a, {
            ...
            _replaceDividers: function() {
                var b, d, e, f, g, h = null,
                    i = this.element;
                for (i.find("li:jqmData(role='list-divider')").remove(), d = i.find("li"), b = 0; b < d.length; b++) e = d[b], f = this.options.autodividersSelector(a(e)), f && h !== f && (g = c.createElement("li"), g.appendChild(c.createTextNode(f)), g.setAttribute("data-" + a.mobile.ns + "role", "list-divider"), e.parentNode.insertBefore(g, e)), h = f
            },
            _create: function() {
                this._super(), this.options.autodividers && this._afterListviewRefresh()
            }
        })
    }(a),
    function(a) {
    ...
    function(a, b) {
        a.widget("mobile.checkboxradio", a.extend({
            ...
            _wrapper: function() {
                return a("<div class='" + (this.options.wrapperClass ? this.options.wrapperClass : "") + " ui-" + this.inputtype + (this.options.disabled ? " ui-disabled" : "") + "' >")
            },
            ...
            _handleLabelVClick: function(a) {
                var b = this.element;
                return b.is(":disabled") ? (a.preventDefault(), void 0) : (this._cacheVals(), b.prop("checked", "radio" === this.inputtype && !0 || !b.prop("checked")), b.triggerHandler("click"), this._getInputSet().not(b).prop("checked", !1), this._updateAll(), !1)
            },
            _cacheVals: function() {
            ...
            refresh: function() {
                var b = this.element[0],
                    ...
                    d = 0 === this.element.parents(".ui-controlgroup-horizontal").length,
                    e = this.checkedClass + (d ? "" : c),
                    f = this.label;
                f.toggleClass("ui-icon-" + this.checkedicon, b.checked).toggleClass("ui-icon-" + this.uncheckedicon, !b.checked), b.checked ? f.removeClass(this.uncheckedClass + c).addClass(e) : f.removeClass(e).addClass(this.uncheckedClass)
            },
            widget: function() {
                return this.label.parent()
            },
            _setOptions: function(c) {
                c.disabled !== b && (this.input.prop("disabled", !!c.disabled), this.widget().toggleClass("ui-disabled", !!c.disabled)), c.mini !== b && this.label.parent().toggleClass("ui-mini", !!c.mini), c.theme !== b && this.label.removeClass("ui-btn-" + this.options.theme).addClass("ui-btn-" + c.theme), c.wrapperClass !== b && this.widget().removeClass(this.options.wrapperClass).addClass(c.wrapperClass), c.iconpos !== b && 0 === this.element.parents("[data-" + a.mobile.ns + "type='horizontal']").length ? this.label.removeClass("ui-btn-icon-" + this.options.iconpos).addClass("ui-btn-icon-" + c.iconpos) : 0 !== this.element.parents("[data-" + a.mobile.ns + "type='horizontal']").length && this.label.removeClass("ui-btn-icon-" + this.options.iconpos), this._super(c)
            }
        }, a.mobile.behaviors.formReset))
    }(a),
    function(a, b) {
        a.widget("mobile.button", {
            ...
            _button: function() {
                return a("<div class='ui-btn ui-input-btn" + (this.options.wrapperClass ? " " + this.options.wrapperClass : "") + (this.options.theme ? " ui-btn-" + this.options.theme : "") + (this.options.corners ? " ui-corner-all" : "") + (this.options.shadow ? " ui-shadow" : "") + (this.options.inline ? " ui-btn-inline" : "") + (this.options.mini ? " ui-mini" : "") + (this.options.disabled ? " ui-disabled" : "") + (this.options.iconpos && this.options.icon ? " ui-btn-icon-" + this.options.iconpos : this.options.icon ? " ui-btn-icon-left" : "") + (this.options.icon ? " ui-icon-" + this.options.icon : "") + "' >" + this.element.val() + "</div>")
            },
            widget: function() {
                return this.wrapper
            },
        ...
        a.widget("mobile.textinput", {
            ...
            _create: function() {
                var b = this.options,
                    ...
                    e = (this.element.is("input") || this.element.is("[data-" + (a.mobile.ns || "") + "type='search']")) && !this.element.is("[data-" + (a.mobile.ns || "") + "type='range']");
                a.extend(this, {
                    themeclass: "ui-body-" + (null === b.theme ? "inherit" : b.theme),
                    isSearch: c,
                    isTextarea: d,
                    inputNeedsWrap: e
                }), this._autoCorrect(), this.element[0].disabled && (this.options.disabled = !0), b.enhanced || this._enhance(), this._on({
                    focus: "_handleFocus",
                    blur: "_handleBlur"
                })
            },
            ...
            _enhance: function() {
                this.isTextarea && this.element.addClass("ui-input-text"), this.element.is("textarea, [data-" + (a.mobile.ns || "") + "type='range']") && (this.element.addClass("ui-shadow-inset"), this._setOptions(this.options)), this.inputNeedsWrap && this.element.wrap(this._wrap())
            },
            widget: function() {
            ...
            _wrap: function() {
                var b = this.options;
                return a("<div class='" + (this.isSearch ? "ui-input-search " : "ui-input-text ") + "ui-body-" + (null === b.theme ? "inherit" : b.theme) + " " + (b.corners ? "ui-corner-all " : "") + (b.mini ? "ui-mini " : "") + (b.disabled ? "ui-state-disabled " : "") + ("" !== b.wrapperClass ? b.wrapperClass + " " : "") + "ui-shadow-inset'></div>")
            },
            ...
            _handleBlur: function() {
                this.element.removeClass(a.mobile.focusClass), this.options.preventFocusZoom && a.mobile.zoom.enable(!0)
            },
            _handleFocus: function() {
                this.options.preventFocusZoom && a.mobile.zoom.disable(!0), this.element.addClass(a.mobile.focusClass)
            },
            _setOptions: function(a) {
                var c, d = this.widget();
                this._super(a), a.theme !== b && (c = "ui-body-" + (null === a.theme ? "inherit" : a.theme), d.removeClass(this.themeclass).addClass(c), this.themeclass = c), a.corners !== b && d.toggleClass("ui-corner-all", a.corners), a.mini !== b && d.toggleClass("ui-mini", a.mini), a.disabled !== b && (this.element.prop("disabled", !!a.disabled), d.toggleClass("ui-disabled", !!a.disabled))
            },
            _destroy: function() {
                this.options.enhanced || (this.inputNeedsWrap && this.element.unwrap(), this.element.removeClass("ui-input-text " + this.themeclass + " ui-corner-all ui-mini ui-disabled"))
            }
        })
    }(a),
    function(a, d) {
        a.widget("mobile.slider", a.extend({
            ...
            refresh: function(b, d, e) {
                ...
                } else null == b && (b = m ? parseFloat(l.val() || 0) : l[0].selectedIndex), k = 100 * ((parseFloat(b) - o) / (p - o));
            ...
            _setDisabled: function(a) {
                a = !!a, this.element.prop("disabled", a), this.slider.toggleClass("ui-disabled", a).attr("aria-disabled", a)
            }
        }, a.mobile.behaviors.formReset))
    }(a),
    function(a, b) {
        a.widget("mobile.flipswitch", a.extend({
            ...
            _create: function() {
                ...
                }) : this._enhance(), this.element.is(":disabled") && this._setOptions({
                    disabled: !0
            ...
            _left: function() {
                this.flipswitch.removeClass("ui-flipswitch-active"), "SELECT" === this.type ? this.element.get(0).selectedIndex = 0 : this.element.prop("checked", !0), this._trigger("change")
            },
            _right: function() {
                this.flipswitch.addClass("ui-flipswitch-active"), "SELECT" === this.type ? this.element.get(0).selectedIndex = 1 : this.element.prop("checked", !1), this._trigger("change")
            },
            _enhance: function() {
                var b = a("<div>"),
                    c = this.options.theme ? this.options.theme : "inherit",
                    d = a("<span tabindex='1'></span>"),
                    e = a("<span></span>"),
                    f = this.element.get(0).tagName,
                    g = "INPUT" === f ? this.options.onText : this.element.find("option").eq(1).text(),
                    h = "INPUT" === f ? this.options.offText : this.element.find("option").eq(0).text();
                d.addClass("ui-flipswitch-on ui-btn ui-shadow ui-btn-inherit").text(g), e.addClass("ui-flipswitch-off").text(h), b.addClass("ui-flipswitch ui-shadow-inset ui-corner-all ui-bar-" + c + " " + (this.options.wrapperClass ? this.options.wrapperClass : "") + " " + (this.element.is(":checked") || this.element.find("option").eq(1).is(":selected") ? "ui-flipswitch-active" : "") + (this.element.is(":disabled") ? " ui-state-disabled" : "") + (this.options.mini ? " ui-mini" : "")).append(d, e), this.element.addClass("ui-flipswitch-input"), this.element.after(b).appendTo(b), a.extend(this, {
                    flipswitch: b,
                    on: d,
                    off: e,
                    type: f
            ...
            _change: function() {
                var a;
                a = "SELECT" === this.type ? this.element.get(0).selectedIndex > 0 ? "_right" : "_left" : this.element.is(":checked") ? "_right" : "_left", this[a]()
            },
            _toggle: function() {
            ...
            _setOptions: function(a) {
                ...
                a.onText !== b && this.on.text(a.onText), a.offText !== b && this.off.text(a.offText), a.disabled !== b && this.widget().toggleClass("ui-state-disabled", a.disabled), a.mini !== b && this.widget().toggleClass("ui-mini", a.mini), this._super(a)
            },
            _destroy: function() {
        ...
        a.widget("mobile.rangeslider", a.extend({
            ...
            _create: function() {
                var b = this.element,
                    ...
                    g = a.data(d.get(0), "mobile-slider").slider,
                    h = a.data(e.get(0), "mobile-slider").slider,
                    i = a.data(d.get(0), "mobile-slider").handle,
                    j = a("<div class='ui-rangeslider-sliders' />").appendTo(b);
                d.addClass("ui-rangeslider-first"), e.addClass("ui-rangeslider-last"), b.addClass(c), g.appendTo(j), h.appendTo(j), f.insertBefore(b), i.prependTo(h), a.extend(this, {
                    _inputFirst: d,
                    _inputLast: e,
                    _sliderFirst: g,
                    _sliderLast: h,
        ...
        a.widget("mobile.textinput", a.mobile.textinput, {
            ...
            _autogrow: function() {
                this._on({
                    ...
                    input: "_timeout",
                    paste: "_timeout"
                }), a.trim(this.element.val()) && this._on(!0, a.mobile.window, {
                    load: "_timeout",
                    pagechange: "_timeout"
                })
            },
            _unbindAutogrow: function() {
                this._off(this.element, "keyup change input paste"), this._off(a.mobile.window, "load pagechange")
            },
            keyupTimeout: null,
            _timeout: function() {
                clearTimeout(this.keyupTimeout), this.keyupTimeout = this._delay("_updateHeight", this.options.keyupTimeoutBuffer)
            },
            _updateHeight: function() {
                this.element.css("height", "0px");
                var a, b, c, d = this.element[0].scrollHeight,
                    ...
                    h = f + g,
                    i = d + h + 15;
                0 === e && (a = parseFloat(this.element.css("padding-top")), b = parseFloat(this.element.css("padding-bottom")), c = a + b, i += c), this.element.css("height", i + "px")
            },
            _setOptions: function(a) {
    ...
    function(a) {
        a.mobile.links = function(b) {
            a(b).find("a").jqmEnhanceable().filter(":jqmData(rel='popup')[href][href!='']").each(function() {
                var b = this,
                    d = a(this).attr("href"),
                    e = a.mobile.path.hashToSelector(d),
                    f = d.substring(1);
                b.setAttribute("aria-haspopup", !0), b.setAttribute("aria-owns", f), b.setAttribute("aria-expanded", !1), a(c).on("popupafteropen", e, function() {
                    b.setAttribute("aria-expanded", !0)
                }).on("popupafterclose", e, function() {
    ...
    function(a, c) {
        ...
        a.widget("mobile.popup", {
            ...
            _create: function() {
                ...
                } : (this._ui = this._enhance(b, c), this._applyTransition(d.transition)._setTolerance(d.tolerance)), this._ui.focusElement = this._ui.container, this._on(this._ui.screen, {
            ...
            _calculateFinalLocation: function(b, c) {
                var e, f = c.rc,
                    g = c.menuSize;
                return e = {
                    left: d(f.cx, g.cx, f.x, b.x),
                    top: d(f.cy, g.cy, f.y, b.y)
                }, e.top = Math.max(0, e.top), e.top -= Math.min(e.top, Math.max(0, e.top + g.cy - a.mobile.document.height())), e
            },
            ...
            _closePrerequisitesDone: function() {
                ...
                b.removeAttr("tabindex"), a.mobile.popup.active = c, a(":focus", b[0]).add(b[0]).blur(), this._trigger("afterclose")
            },
            _close: function(b) {
            ...
            _closePopup: function(c, d) {
                var e, f, g = this.options,
                    h = !1;
                c && c.isDefaultPrevented() || a.mobile.popup.active !== this || (b.scrollTo(0, this._scrollTop), c && "pagebeforechange" === c.type && d && (e = "string" == typeof d.toPage ? d.toPage : d.toPage.jqmData("url"), e = a.mobile.path.parseUrl(e), f = e.pathname + e.search + e.hash, this._myUrl !== a.mobile.path.makeUrlAbsolute(f) ? h = !0 : c.preventDefault()), a.mobile.window.off(g.closeEvents), this.element.undelegate(g.closeLinkSelector, g.closeLinkEvents), this._close(h))
            },
            _bindContainerClose: function() {
                a.mobile.window.on(this.options.closeEvents, a.proxy(this, "_closePopup"))
            },
            widget: function() {
            ...
            close: function() {
                return a.mobile.popup.active !== this ? this : (this._scrollTop = a.mobile.window.scrollTop(), this.options.history && this.urlAltered ? (a.mobile.back(), this.urlAltered = !1) : this._closePopup(), this)
            }
        }), a.mobile.popup.handleLink = function(b) {
            var c, d = b.closest(":jqmData(role='page')"),
                e = a.mobile.path,
                f = 0 === d.length ? a("body") : d,
                g = a(e.hashToSelector(e.parseUrl(b.attr("href")).hash), f[0]);
            g.data("mobile-popup") && (c = b.offset(), g.popup("open", {
    ...
    function(a, b) {
        var d = ".ui-disabled,.ui-li-divider,.ui-screen-hidden,:jqmData(role='placeholder')",
            e = function(a, b, c) {
        ...
        a.widget("mobile.selectmenu", a.mobile.selectmenu, {
            ...
            build: function() {
                ...
                return v.nativeMenu ? this._super() : (u = this, c = this.selectId, d = c + "-listbox", e = c + "-dialog", f = this.label, g = this.element.closest(".ui-page"), h = this.element[0].multiple, i = c + "-menu", j = v.theme ? " data-" + a.mobile.ns + "theme='" + v.theme + "'" : "", k = v.overlayTheme ? " data-" + a.mobile.ns + "theme='" + v.overlayTheme + "'" : "", l = v.dividerTheme && h ? " data-" + a.mobile.ns + "divider-theme='" + v.dividerTheme + "'" : "", m = a("<div data-" + a.mobile.ns + "role='dialog' class='ui-selectmenu' id='" + e + "'" + j + k + ">" + "<div data-" + a.mobile.ns + "role='header'>" + "<div class='ui-title'>" + f.getEncodedText() + "</div>" + "</div>" + "<div data-" + a.mobile.ns + "role='content'></div>" + "</div>"), n = a("<div id='" + d + "' class='ui-selectmenu'>").insertAfter(this.select).popup({
                    theme: v.overlayTheme
                }), o = a("<ul class='ui-selectmenu-list' id='" + i + "' role='listbox' aria-labelledby='" + this.buttonId + "'" + j + l + ">").appendTo(n), p = a("<div class='ui-header ui-bar-" + (v.theme ? v.theme : "inherit") + "'>").prependTo(n), q = a("<h1 class='ui-title'>").appendTo(p), this.isMultiple && (t = a("<a>", {
                    role: "button",
                    text: v.closeText,
                    href: "#",
                ...
                }), this.list.delegate("li:not(.ui-disabled, .ui-li-divider)", "click", function(b) {
                    var c = u.select[0].selectedIndex,
                        d = a.mobile.getAttribute(this, "option-index"),
                        e = u._selectOptions().eq(d)[0];
                    e.selected = u.isMultiple ? !e.selected : !0, u.isMultiple && a(this).find("a").toggleClass("ui-icon-checkbox-on", e.selected).toggleClass("ui-icon-checkbox-off", !e.selected), (u.isMultiple || c !== d) && u.select.trigger("change"), u.isMultiple ? u.list.find("li:not(.ui-li-divider)").eq(d).find("a").first().focus() : u.close(), b.preventDefault()
            ...
            refresh: function(b) {
                var c, d;
                return this.options.nativeMenu ? this._super(b) : (c = this, (b || this._isRebuildRequired()) && c._buildList(), d = this.selectedIndices(), c.setButtonText(), c.setButtonCount(), c.list.find("li:not(.ui-li-divider)").find("a").removeClass(a.mobile.activeBtnClass).end().attr("aria-selected", !1).each(function(b) {
                    if (a.inArray(b, d) > -1) {
                        var e = a(this);
                        e.attr("aria-selected", !0), c.isMultiple ? e.find("a").removeClass("ui-icon-checkbox-off").addClass("ui-icon-checkbox-on") : e.hasClass("ui-screen-hidden") ? e.next().find("a").addClass(a.mobile.activeBtnClass) : e.find("a").addClass(a.mobile.activeBtnClass)
                    }
                }), void 0)
            },
            close: function() {
            ...
            _buildList: function() {
                var b, d, e, f, g, h, i, j, k, l, m, n, o, p, q = this,
                    ...
                    s = this.placeholder,
                    t = !0,
                    u = this.isMultiple ? "checkbox-off" : "false",
                    v = "data-" + a.mobile.ns,
                    w = v + "option-index",
                    x = v + "icon",
                    y = v + "role",
    ...
    function(a, b) {
        ...
        a.fn.buttonMarkup = function(f, i) {
            ...
            for (j = 0; j < this.length; j++) {
                ...
                l.className = c(a.extend({}, o, m), k.unknownClasses).join(" "), l.setAttribute("role", "button")
            }
            return this
    ...
    function(a, b) {
        a.widget("mobile.controlgroup", a.extend({
            ...
            _create: function() {
                var b = this.element,
                    c = this.options;
                a.mobile.enhanceWithButtonMarkup && this.element.find(a.mobile.enhanceWithButtonMarkup.initSelector).each(a.mobile.enhanceWithButtonMarkup), a.each(this._childWidgets, a.proxy(function(b, c) {
                    a.mobile[c] && this.element.find(a.mobile[c].initSelector)[c]()
                }, this)), a.extend(this, {
                    _ui: null,
                    _initialRefresh: !0
                }), this._ui = c.enhanced ? {
    ...
    function(a, b) {
        a.widget("mobile.toolbar", {
            ...
            _create: function() {
                var b, c, d, e = this.element.is(":jqmData(role='header')") ? "header" : "footer",
                    f = this.element.closest(".ui-page");
                0 === f.length && (f = !1, this._on(a.mobile.document, {
                    pageshow: "refresh"
                })), a.extend(this, {
                    role: e,
                    page: f,
                    ...
                    rightbtn: c,
                    backBtn: d
                }), this.element.attr("role", "header" === e ? "banner" : "contentinfo").addClass("ui-" + e), this.refresh(), this._setOptions(this.options)
            },
            _setOptions: function(c) {
            ...
            refresh: function() {
                "header" === this.role && this._addHeaderButtonClasses(), this.page || (a("[data-" + a.mobile.ns + "role='page']").css({
                    position: "relative"
                }), "footer" === this.role && this.element.appendTo("body")), this._addHeadingClasses(), this._btnMarkup()
            },
            _btnMarkup: function() {
            ...
            _addBackButton: function() {
                this.backBtn = a("<a role='button' href='javascript:void(0);' class='ui-btn-left ui-toolbar-back-btn' data-" + a.mobile.ns + "rel='back' data-" + a.mobile.ns + "icon='carat-l'>" + this.options.backBtnText + "</a>").attr("data-" + a.mobile.ns + "theme", this.options.backBtnTheme || this.options.theme).prependTo(this.element)
            },
    ...
    function(a, b) {
        a.widget("mobile.toolbar", a.mobile.toolbar, {
            ...
            _create: function() {
                this._super(), "fixed" !== this.options.position || this.options.supportBlacklist() || (this.element.addClass("ui-" + this.role + "-fixed"), this.updatePagePadding(), this._addTransitionClass(), this._bindPageEvents(), this._bindToggleHandlers(), this._setOptions(this.options))
            },
            _setOptions: function(c) {
                if ("fixed" === this.options.position && !this.options.supportBlacklist()) {
            ...
            _bindPageEvents: function() {
                var b = this.page ? this.element.closest(".ui-page") : a.mobile.document;
                this._on(b, {
                    pagebeforeshow: "_handlePageBeforeShow",
            ...
            _handlePageShow: function() {
                this.updatePagePadding(this.page ? this.page : ".ui-page-active"), this.options.updatePagePadding && this._on(a.mobile.window, {
                    throttledresize: "updatePagePadding"
                })
            },
            _handlePageBeforeHide: function(b, c) {
                var d, e, f, g, h = this.options;
                h.disablePageZoom && a.mobile.zoom.enable(!0), h.updatePagePadding && this._off(a.mobile.window, "throttledresize"), h.trackPersistentToolbars && (d = a(".ui-footer-fixed:jqmData(id)", this.page), e = a(".ui-header-fixed:jqmData(id)", this.page), f = d.length && c.nextPage && a(".ui-footer-fixed:jqmData(id='" + d.jqmData("id") + "')", c.nextPage) || a(), g = e.length && c.nextPage && a(".ui-header-fixed:jqmData(id='" + e.jqmData("id") + "')", c.nextPage) || a(), (f.length || g.length) && (f.add(g).appendTo(a.mobile.pageContainer), c.nextPage.one("pageshow", function() {
    ...
    function(a, c) {
        a.widget("mobile.panel", {
            ...
            _getWrapper: function() {
                var b = this._page().find("." + this.options.classes.pageWrapper),
                    c = a.support.cssTransform3d && this.options.animate ? " " + this.options.classes.animate : "";
                return 0 === b.length && (b = this._page().children(".ui-header:not(:jqmData(position='fixed')), .ui-content:not(:jqmData(role='popup')), .ui-footer:not(:jqmData(position='fixed'))").wrapAll("<div class='" + this.options.classes.pageWrapper + c + "' /></div>").parent()), b
            },
            _getFixedToolbars: function() {
                var b = a("body").children(".ui-header:jqmData(position='fixed'), .ui-footer:jqmData(position='fixed')"),
                    c = this._page().find(".ui-header:jqmData(position='fixed'), .ui-footer:jqmData(position='fixed')"),
            ...
            _bindPageEvents: function() {
                var b = this;
                a.mobile.document.on("panelbeforeopen", function(a) {
                    b._open && a.target !== b.element[0] && b.close()
                }).on("keyup.panel", function(a) {
                    27 === a.keyCode && b._open && b.close()
                }), b._parentPage ? a.mobile.document.on("pagehide", ":jqmData(role='page')", function() {
                    b._open && b.close(!0)
                }) : a.mobile.document.on("pagebeforehide", function() {
                    b._open && b.close(!0)
                })
            },
            _open: !1,
            ...
            close: function(b) {
                if (this._open) {
                    var c = this,
                        ...
                        f = function() {
                            a.mobile.document.off(c._transitionEndEvents, f), d.theme && "overlay" !== d.display && c._page().parent().removeClass(d.classes.pageContainer + "-themed " + d.classes.pageContainer + "-" + d.theme), c.element.addClass(d.classes.panelClosed), "overlay" !== d.display && (c._page().parent().removeClass(d.classes.pageContainer), c._wrapper().removeClass(d.classes.pageContentPrefix + "-open"), c._fixedToolbars().removeClass(d.classes.pageContentPrefix + "-open")), a.support.cssTransform3d && d.animate && "overlay" !== d.display && (c._wrapper().removeClass(d.classes.animate), c._fixedToolbars().removeClass(d.classes.animate)), c._fixPanel(), c._unbindFixListener(), a.mobile.resetActivePageHeight(), c._page().jqmRemoveData("panel"), c._trigger("close")
                        };
            ...
            _destroy: function() {
                var b = this.options,
                    c = a("body > :mobile-panel").length + a.mobile.activePage.find(":mobile-panel").length > 1;
        ...
        a.widget("mobile.table", a.mobile.table, {
            ...
            _create: function() {
                this._super(), "columntoggle" === this.options.mode && (a.extend(this, {
                    _menu: null
                }), this.options.enhanced ? this._menu = this.document.find(this._id() + "-popup").children().first() : (this._menu = this._enhanceColToggle(), this.element.addClass(this.options.classes.columnToggleTable)), this._setupEvents(), this._setToggleState())
            },
            _id: function() {
            ...
            _addToggles: function(b, c) {
                var d = this.options;
                c || b.empty(), this.headers.not("td").each(function() {
                    var e = a(this),
                        f = a.mobile.getAttribute(this, "priority"),
                        g = e.add(e.jqmData("cells"));
                    f && (g.addClass(d.classes.priorityPrefix + f), c || a("<label><input type='checkbox' checked />" + (e.children("abbr").first().attr("title") || e.text()) + "</label>").appendTo(b).children(0).jqmData("cells", g).checkboxradio({
                        theme: d.columnPopupTheme
                    }))
                }), c || this._bindToggles(b)
            },
    ...
    function(a, b) {
        ...
        }), void 0) : (a.mobile.iosorientationfixEnabled = !1, void 0)
    }(a, this),
    function(a, b) {
        function d() {
        ...
        a(b.document).trigger("mobileinit"), a.mobile.gradeA() && (a.mobile.ajaxBlacklist && (a.mobile.ajaxEnabled = !1), e.addClass("ui-mobile ui-mobile-rendering"), setTimeout(d, 5e3), a.extend(a.mobile, {
            ...
            a.support.inlineSVG(), a.mobile.hideUrlBar && b.scrollTo(0, 1), a.mobile.defaultHomeScroll = a.support.scrollTop && 1 !== a.mobile.window.scrollTop() ? 1 : 0, a.mobile.autoInitializePage && a.mobile.initializePage(), a.mobile.hideUrlBar && f.load(a.mobile.silentScroll), a.support.cssPointerEvents || a.mobile.document.delegate(".ui-disabled", "vclick", function(a) {
...
/*
//@ sourceMappingURL=jquery.mobile-1.4.0-alpha.2.min.map
*/